...
describe('calculMention() — validation', () => {
  ...
  test('lève une erreur si la moyenne est négative', () => {
    // On enveloppe l'appel dans une fonction fléchée 
    // car Jest doit intercepter l'exception lancée. 
    // Si on écrivait directement, l'erreure planterait JEST avant qu'il puisse la capturer
